...
export default function TelaConfirmacao({navigation}) {
    return(
        ...
        <View style={globalStyles.container}>
            ...
            <TouchableOpacity style={[globalStyles.button, {width: 254, height: 48, marginTop: "9%"}]} onPress={() => navigation.navigate('DrawerLayout')}>
                <Text style={{fontSize: 24, color: 'white', fontWeight: 'bold', textAlign: 'center'}}>Confirmar</Text>
            </TouchableOpacity>

            <View style={{marginTop: "30%"}}>
                <Text style={{paddingLeft: 100, paddingRight: 100, fontSize: 16, textAlign: 'center'}}> 
                    Caso não receba o SMS, veja se o telefone inserido é válido, ou tente novamente
                </Text>
                <TouchableOpacity underlayColor={'white'} style={[globalStyles.button, {alignSelf: 'center', width: 'auto', height: 'auto', marginTop: 5, paddingVertical: 8}]} onPress={() => navigation.navigate('login')}>
