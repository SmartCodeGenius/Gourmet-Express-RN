    ...
    return(
        <View style={globalStyles.container}>
            ...
            <View style={[globalStyles.containerForm, {marginTop: 80}]}>
                <TextInput style={[globalStyles.textInput, {width: 330, height: 42}]} placeholder="Nova senha"></TextInput>
                <TextInput style={[globalStyles.textInput, {width: 330, height: 42, marginTop: 40}]} placeholder="Confirmar senha"></TextInput>
